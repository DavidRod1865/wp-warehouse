...
import { faChevronLeft, faTruck } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Driver Log In</p>
          <FontAwesomeIcon icon={faTruck} className="text-blue-600 text-4xl mt-4" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="john.smith@drivers.local"
            />
          </div>
